 ...
 */
interface SketchGraphicsOverlayEventListener {
     ...
     */
    fun onUndoStateChanged(undoEnabled: Boolean)
     ...
     */
    fun onRedoStateChanged(redoEnabled: Boolean)
     ...
     */
    fun onClearStateChanged(clearEnabled: Boolean)
