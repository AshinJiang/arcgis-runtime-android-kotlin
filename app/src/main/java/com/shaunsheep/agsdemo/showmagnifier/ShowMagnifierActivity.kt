...
package com.shaunsheep.agsdemo.showmagnifier
...
class ShowMagnifierActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setTitle(R.string.title_show_magnifier)
        ...
        mMapView!!.map = mMap
        // enable magnifier
        mMapView!!.isMagnifierEnabled = true
